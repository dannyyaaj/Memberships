...
namespace Memberships.Extensions
{
    ...
    {
        private static async Task<List<int>> GetSubscriptionsIdAsync(
            string userId = null, ApplicationDbContext db = null)
        {
            try
            {
                ...
                return await (
                    ...
                    select us.SubscritionId).ToListAsync();
            }
            catch { }
            ...
            ApplicationDbContext db = null)
        {
            try
            {
                ...
                var subscriptionIds = await GetSubscriptionsIdAsync(userId, db);
